...
| Test counts | Current docs copied different totals from different historical commits. | `project-facts.yaml` preserves the 212 Python / 30 TS / 22 Rust + 1 ignored / 4 Playwright pre-Autofix baseline and separately records the completed 268 Python / 60 TS / 22 Rust + 1 ignored / 5 Playwright Autofix matrix. |
